        ...
        <div className="flex flex-col items-center justify-between w-full mb-10 lg:flex-row">
          <div className="mb-16 lg:mb-0 lg:max-w-lg lg:pr-5">
            <div className="max-w-xl mb-6">
              ...
              <h2 style={{whiteSpace:"nowrap"}} className="font-sans text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl sm:leading-none max-w-lg mb-6">
                Hire From Anywhere
              </h2>
              </div>
              <div >
              <p style={{textAlign:"left", marginLeft: "10px"}} className="text-gray-700 text-base md:text-lg">
                Our Global Mobility team helps with the visa process, doing all
                the heavy lifting. We also support fully remote hires. Or
