...
const Review = () => {
    return (
        <div className="carousel h-56 w-full mb-20">
            <div id="slide1" className="carousel-item relative w-full">
                <div className='grid lg:grid-cols-4 md:grid-cols-3 grid-cols-1 gap-2 lg:gap-4'>
                    <div className="container flex flex-col w-full max-w-lg p-5 mx-auto divide-y rounded-md divide-gray-700 border">
                        <div className="p-3">
