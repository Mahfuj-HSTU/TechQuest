...
const Customers = () => {
  ...
  const jobSeeker = users.filter((user) => {
    return user.role === "jobSeeker";
  });
  const recruiter = users.filter((user) => {
  ...
  return (
    <div data-aos="fade-up" className="my-16">
      ...
      <div className=" bg-gradient-to-b from-slate-800 to-slate-700 h-full lg:h-96 w-full bg-cover bg-center relative">
        ...
        <div
          data-aos="fade-up"
          className="p-24 grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-2 justify-items-center lg:px-0 px-4"
        >
          <div
            data-aos="fade-up"
          ...
          >
            <div className="card-body items-center">
              <h1 className=" card-title text-7xl">
                <FaUsers className="text-warning text-5xl" />{" "}
                <CountUp
                  start={0}
                  end={users.length}
                  duration={2}
          ...
          >
            <div className="card-body items-center">
              <h1 className=" card-title text-7xl">
                <FaUserTie className="text-warning text-5xl" />{" "}
                <CountUp
                  start={0}
                  end={jobSeeker.length}
                  duration={2}
                  delay={0}
                  enableScrollSpy
                />
          ...
          >
            <div className="card-body items-center">
              <h1 className=" card-title text-7xl">
                <FaUserGraduate className="text-warning text-5xl" />{" "}
                <CountUp
                  start={0}
                  end={recruiter.length}
                  duration={2}
                  delay={0}
                  enableScrollSpy
                />
          ...
          >
            <div className="card-body items-center">
              <h1 className=" card-title text-7xl">
                <MdWork className="text-warning text-5xl" />{" "}
                <CountUp
                  start={0}
                  end={jobs.length}
                  duration={2}
