...
const Banner = () => {
  ...
  return (
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 min-h-full px-4 md:px-8 lg:max-w-screen-xl -mt-8 rounded-md bg-gradient-to-r from-violet-600  to-[#0675CE] shadow-lg shadow-info">
