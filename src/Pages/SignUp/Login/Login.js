            ...
            <div className="card flex-shrink-0 w-full max-w-md shadow-2xl bg-base-100 py-10">
                ...
                <form onSubmit={ handleLogin } className="card-body">
                    ...
                    <div className="form-control">
                        ...
                        <p className='text-start text-red-600 font-semibold'>{ error.slice( 22, 43 ) }</p>
                    </div>
                    <div className="form-control mt-6">
                        <input className="btn btn-primary" type="submit" value="Login" />
                    </div>
                </form>
                <p className='text-center'>New to TechQuest <label htmlFor="sign-up-modal" className='text-orange-600 font-bold cursor-pointer' to='/registration'>Sign Up</label></p>
