  ...
  const { data: MyJobPost = [], refetch } = useQuery({
    ...
    queryFn: async () => {
      const res = await fetch(
        `${ServerLink}/recruiterJobPosts?email=${user?.email}`
      );
  ...
  return (
    <div>
      <h3 className="text-4xl font-bold text-center my-5">
        Search for applicants by posting
      </h3>
      <div className="grid lg:grid-cols-4 md:grid-cols-3 mx-5 gap-5">
        ...
        <div className="md:col-span-1 hidden lg:inline md:inline">
          <div className="card bg-base-100 shadow-xl text-left">
            <figure>
              <img
                src="https://quickbooks.intuit.com/oidam/intuit/sbseg/en_ca/blog/images/part-time-vs-full-time-photo-qbo-ca-desktop.jpeg"
                alt="Shoes"
              />
            </figure>
            <div className="card-body">
              ...
              <div className="card-actions justify-end">
                <Link to="/recruiter/all-job-seekers">
          ...
          <div className="card bg-base-100 shadow-xl text-left my-8">
            <figure>
              <img
                src="https://surejob.in/wp-content/uploads/2022/12/job-posting-sites-1024x585.jpg"
                alt="Shoes"
              />
            </figure>
            <div className="card-body">
              ...
              <p>
                ...
                work than follow your passions in a way that serves the world
                and you.
              </p>
              <div className="card-actions justify-end">
                <Link to="/all-jobs">
                  <button className="btn btn-warning">Search Jobs</button>
                </Link>
